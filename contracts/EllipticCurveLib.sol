...
/**
 * @dev Library provides arithmetic operations over elliptic curves.
 * The libary uses projective and Jacobian coordinates [1], [2] to speed up computations on the curves
 * [1] https://en.wikibooks.org/wiki/Cryptography/Prime_Curve/Standard_Projective_Coordinates
...
library EllipticCurveLib {
  ...
  */
  ...
  /**
   * @dev Modular exponentiation, b^e % _pp. Source: https://github.com/androlo/standard-contracts/blob/master/contracts/src/crypto/ECCMath.sol
   * @param _base base
   * @param _exp exponent
   * @param _pp modulus
  ...
  */
  ...
  /**
   * @dev comepare two points on the curve
   * @param _x1: coordinate x of P1
   * @param _y1: coordinate y of P1
   * @param _x2: coordinate x of P2
   * @param _y2: coordinate y of P2
  ...
  */
  ...
  function comparePoints(uint256 _x1, uint256 _y1, uint256 _x2, uint256 _y2) public pure returns(bool){
      if((_x1==_x2) && (_y1==_y2)){
          return true;
      }
